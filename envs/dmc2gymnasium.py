...
Taken from 
- https://github.com/Farama-Foundation/Shimmy/blob/main/shimmy/utils/dm_env.py
- https://github.com/Farama-Foundation/Shimmy/blob/main/shimmy/dm_control_compatibility.py
...
def dm_env_step2gym_step(timestep) -> tuple[Any, float, bool, bool, dict[str, Any]]:
    ...
    info = {
        ...
        "timestep.physics": timestep.physics,
    }
...
class DMControlToGymnasiumWrapper(gymnasium.Env[ObsType, np.ndarray], EzPickle):
